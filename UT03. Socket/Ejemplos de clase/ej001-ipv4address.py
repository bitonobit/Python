# Ejemplo de uso de la clase IPv4Address del módulo ipaddress
import ipaddress # importar módulo ipaddress

ip = ipaddress.IPv4Address('192.168.0.0') # crear objeto IPv4Address
